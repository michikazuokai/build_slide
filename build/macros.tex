...
\newcommand{\assetpath}{/Volumes/NBPlan/TTC/授業資料/2026年度/}
\newcommand{\pgfpath}{\assetpath/\detokenize{1020701.GITバージョン管理/02}/images/} 
\newcommand{\codedir}{\assetpath/\detokenize{1020701.GITバージョン管理/02}} 

% 画像検索パスの設定
\graphicspath{{images/}{\assetpath/\detokenize{1020701.GITバージョン管理/02}/images/}{../project_assets/images/}{../project_assets/emoji/emoji_pngs/}} 

% フッター用テキスト
%\newcommand{\myfootertext}{1020701.GITバージョン管理/02} 
\newcommand{\myfootertext}{\detokenize{1020701.GITバージョン管理/02}}
